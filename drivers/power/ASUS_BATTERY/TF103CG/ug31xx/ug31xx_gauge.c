...
#include "ug31xx_ggb_data_TF103CG_20140516_071148.h"
#include "../uPILogger.h"
#endif
...
//[Carlisle]Workaround for ERP COS power consumption when battery 100% +++ 
       if(entry_mode == 4 && ug31->batt_capacity >= 100)
       {
			   GAUGE_info("Call stop_wakelock_in_cos\n");
               stop_wakelock_in_cos();
       }
//[Carlisle]Workaround for ERP COS power consumption when battery 100% ---
