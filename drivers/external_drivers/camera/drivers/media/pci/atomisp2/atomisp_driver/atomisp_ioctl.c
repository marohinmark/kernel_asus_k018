...
static struct v4l2_queryctrl ci_v4l2_controls[] = {
	...
	},
	{
        ...
        //iCatch 3A information---
        {
                ...
                .name = "3a lock",
                .minimum = 0,
                .maximum = V4L2_LOCK_EXPOSURE | V4L2_LOCK_WHITE_BALANCE | V4L2_LOCK_FOCUS,
                .step = 1,
                .default_value = 0,
        },
};
			  ...
			  struct v4l2_control *control)
{
	...
	case V4L2_CID_IRIS_RELATIVE: //ASUS_BSP+++, set ROI trigger
        ...
        case V4L2_CID_EFFECT_AURA: //ASUS+++, set aura
        case V4L2_CID_MOVING: //ASUS+++, set moving mode
        case V4L2_CID_WDR: //ASUS+++, set WDR mode
        case V4L2_CID_HDR: //ASUS+++, set HDR mode
        case V4L2_CID_EIS: //ASUS+++, set EIS mode
        case V4L2_CID_3A_LOCK_ISP: //ASUS+++, set 3A lock
		mutex_unlock(&isp->mutex);
	...
	struct v4l2_ext_controls *c)
{
	...
	for (i = 0; i < c->count; i++) {
		...
		case V4L2_CID_FOCUS_STATUS:
		case V4L2_CID_FOCUS_AUTO:
                case V4L2_CID_EXPOSURE_AREAS: //ASUS_BSP, Camera5.0
                case V4L2_CID_GSENSOR: //ASUS+++ May, set Gsensor data
	...
	struct v4l2_streamparm *parm)
{
	...
	default:
        ...
        status_mode = v4l2_subdev_call(isp->inputs[asd->input_curr].camera, sensor, s_modes, (u32) mode);
        if(status_mode == -EINVAL)
