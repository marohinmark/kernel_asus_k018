...
static int gc0339_init_common(struct v4l2_subdev *sd)
{
	...
	gc0339_write_reg(client, MISENSOR_8BIT,  0x14, 0x03);
	...
	//ret = gc0339_write_reg_array(client, gc0339_common, PRE_POLLING);
	//if (ret)
	//	return ret;
//	ret = gc0339_write_reg_array(client, gc0339_iq, NO_POLLING);
			      ...
			      struct v4l2_mbus_framefmt *fmt)
{
	...
	case GC0339_RES_CIF:
		...
		gc0339_write_reg(c, MISENSOR_8BIT,  0x0A, 0x32);  // by Wesley
		gc0339_write_reg(c, MISENSOR_8BIT,  0x0B, 0x01);  // by Wesley
		gc0339_write_reg(c, MISENSOR_8BIT,  0x0C, 0x74);  // by Wesley
