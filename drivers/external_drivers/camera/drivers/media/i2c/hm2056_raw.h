...
#define HM2056_NAME				"hm2056" //Change by wesley
...
static struct hm2056_reg const hm2056_stream_off[] = {
	...
	//{HM2056_TOK_DELAY, 0, 100},	// disable by Wesley
	{HM2056_TOK_TERM, 0, 0}
};
...
static struct hm2056_reg const hm2056_init[] = {
	...
	{HM2056_8BIT, 0x0006, 0x03},	// Flip/Mirror
	...
	{HM2056_8BIT, 0x05E4, 0x00}, //Wesley1 00->	//Windowing
	{HM2056_8BIT, 0x05E5, 0x00},
	{HM2056_8BIT, 0x05E6, 0x53}, //Wesley2 53->
	{HM2056_8BIT, 0x05E7, 0x06},
	{HM2056_8BIT, 0x05E8, 0x0A}, //Wesley3 0x0A(sensor default)->
	{HM2056_8BIT, 0x05EA, 0xB9}, //Wesley4 0xB9(sensor default)->
	...
	{HM2056_8BIT, 0x0B04, 0x05}, //Wesley 01->05 Final setting
...
static struct hm2056_reg const hm2056_uxga_14fps[] = {
	...
	//{HM2056_8BIT, 0x05E4, 0x0A}, //Welsey1 0x0A(sensor default)->
	{HM2056_8BIT, 0x05E6, 0x53}, //Wesley2 53->
	{HM2056_8BIT, 0x05E7, 0x06},
	//{HM2056_8BIT, 0x05E8, 0x0A}, //Wesley3 0x0A(sensor default)->
	{HM2056_8BIT, 0x05EA, 0xC3}, //Wesley4 C3->
...
static struct hm2056_reg const hm2056_uxga_16_9_18fps[] = {
	...
	{HM2056_8BIT, 0x0190, 0x80},
	{HM2056_8BIT, 0x0192, 0x48},
	//{HM2056_8BIT, 0x05E4, 0x0A}, //Wesley1 0x0A(sensor default)->
	{HM2056_8BIT, 0x05E6, 0x53}, //Wesley2 53->
	{HM2056_8BIT, 0x05E7, 0x06},
	//{HM2056_8BIT, 0x05E8, 0x0A}, //Wesley3 0x0A(sensor default)->
	{HM2056_8BIT, 0x05EA, 0x8F}, //Wesley4 8f->
...
/*
 * 1296x732->812 by Wesley
 */
static struct hm2056_reg const hm2056_720p_25fps[] = {
	{HM2056_8BIT, 0x0024, 0x00},
	{HM2056_8BIT, 0x0006, 0x07}, //720P setting 1/3 //#0B->1B	// Flip/Mirror
	{HM2056_8BIT, 0x000D, 0x00},	// 20120220 to fix morie
	{HM2056_8BIT, 0x000E, 0x00},	// Binning ON
	{HM2056_8BIT, 0x0010, 0x00},
	{HM2056_8BIT, 0x0011, 0xCE},
	{HM2056_8BIT, 0x0012, 0x08},	//2012.02.08
	{HM2056_8BIT, 0x0013, 0x00},
	{HM2056_8BIT, 0x002A, 0x2F},
	{HM2056_8BIT, 0x0071, 0x99},
	{HM2056_8BIT, 0x0074, 0x13},
	//{HM2056_8BIT, 0x0078, 0x00}, //#
	//{HM2056_8BIT, 0x0079, 0xF2}, //#
	//{HM2056_8BIT, 0x007A, 0x03}, //#
	//{HM2056_8BIT, 0x007B, 0xCF}, //#
	{HM2056_8BIT, 0x0082, 0xE2},
	{HM2056_8BIT, 0x0131, 0xB8},	//simle bpc enable[4]
	...
	//{HM2056_8BIT, 0x05E4, 0x0A}, //Wesley1 0x0A(sensor default)->
	{HM2056_8BIT, 0x05E6, 0x0F}, //Wesley2 0f->
	{HM2056_8BIT, 0x05E7, 0x05},
	//{HM2056_8BIT, 0x05E8, 0x00}, //#non by init->00 //Wesley3 0x0A->
	//{HM2056_8BIT, 0x05E9, 0x00}, //#
	{HM2056_8BIT, 0x05EA, 0x2B}, //720P setting 2/3 //#DB->DD //Wesley4 DB->
	{HM2056_8BIT, 0x05EB, 0x03}, //720P setting 3/3
	{HM2056_8BIT, 0x0024, 0x40},
...
static struct hm2056_reg const hm2056_svga_30fps[] = {	
	...
	{HM2056_8BIT, 0x0192, 0x48},
	//{HM2056_8BIT, 0x05E4, 0x0A}, //Wesley1 0x0A(sensor default)->
	{HM2056_8BIT, 0x05E6, 0x2D}, //Wesley2 2B(812) ->2D(814)
	{HM2056_8BIT, 0x05E7, 0x03},
	//{HM2056_8BIT, 0x05E8, 0x0A}, //Wesley3 0x0A(sensor default)->
	{HM2056_8BIT, 0x05EA, 0x71}, //Wesley4 71(626)
...
/*remove for snapshot vga use full size data
	{
	...
	.vertical_end = 1251,
	.pixel_clk = 39000000,
	.line_length_pck = 1277,
	.frame_length_lines = 626,
	.bin_factor_x = 2,
	.bin_factor_y = 2,
	.bin_mode = 1,
	},*/
