...
#ifdef CONFIG_SUPPORT_MIPI_TRULY_VIDEO_DISPLAY
extern struct platform_driver truly_lcd_driver;
#endif

#ifdef CONFIG_TF103CG
extern struct platform_driver b101ean01_vid_lcd_driver;
#endif
...
#ifdef CONFIG_SUPPORT_MIPI_HX8279_DISPLAY
extern struct platform_driver hx8279_vid_lcd_driver;
#endif
...
static bool intel_mid_get_vbt_data(struct drm_psb_private *dev_priv)
{
	...
	strncpy(panel_name, "HX8279", strlen("HX8279"));
	mipi_mode = MDFLD_DSI_ENCODER_DPI;
	goto out;
#endif

#ifdef CONFIG_TF103CG
	strncpy(panel_name, "B101EAN01", strlen("B101EAN01"));
	mipi_mode = MDFLD_DSI_ENCODER_DPI;
	goto out;
#endif
...
#ifdef CONFIG_SUPPORT_MIPI_TRULY_VIDEO_DISPLAY
	ret = platform_driver_register(&truly_lcd_driver);
	if (ret != 0) {
		return ret;
	}
#endif
...
#ifdef CONFIG_TF103CG
        ret = platform_driver_register(&b101ean01_vid_lcd_driver);
        if (ret != 0) {
                return ret;
        }
#endif
...
#ifdef CONFIG_SUPPORT_MIPI_HX8279_DISPLAY
	ret = platform_driver_register(&hx8279_vid_lcd_driver);
#endif
