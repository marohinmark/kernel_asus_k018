...
#if (defined CONFIG_FE170CG || defined CONFIG_TF103CG)
	/* projects with modem V2 (FE170CG/TF103CG) */
	pr_info(DRVNAME ": modem V2\n");
...
#else /* projects with modem V1 (ME560CG) */
	pr_info(DRVNAME ": modem V1\n");
